class Base64Decoder {
  ...
  static decode = value => {
    return value == null || value === undefined ? value
      : typeof value == 'string' ? this.decodeString(value)
      : typeof value == 'object' 
        && !Array.isArray(value) ? this.decodeObjectValues(value)
      : Array.isArray(value) ? this.decodeStringArray(value)
      : value;
  };
  ...
  static decodeObjectValues = obj => {
    ...
    Object
      .entries(obj)
      .forEach(([key, value]) => o[key] = this.decode(value));
    return o;
  };
}
