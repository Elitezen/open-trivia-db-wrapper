...
//   // expect(async() => {
//   //   await openTDBRequest({} as unknown as string);
//   // }).toThrow();

//   // expect(async() => {
//   //   await openTDBRequest(1 as unknown as string);
//   // }).toThrow();

//   // expect(openTDBRequest('')).toThrow();

//   // expect(async() => {
//   //   await openTDBRequest('https://example.com/');
//   // }).toBeTruthy();
// });
