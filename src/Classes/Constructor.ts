import type { CategoryData, Question, RawCategoryResponse, RawQuestion } from "../typings/interface";
    ...
    return rawQuestions.map(question => {
      return {
        ...
        category: {
          ...
          id: Category.idByName(question.category) as number
        },
        type: question.type,
        difficulty: question.difficulty,
        correctAnswer: question.correct_answer,
        incorrectAnswers: question.incorrect_answers,
        allAnswers: Util.shuffleArray([question.correct_answer, ...question.incorrect_answers])
      }
    })
  }
}