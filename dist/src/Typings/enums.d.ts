declare enum CategoryNamesStrict {
    GENERAL_KNOWLEDGE = 9,
...
declare enum CategoryNamesPretty {
    "General Knowledge" = 9,
...
declare enum CategoryNameVersions {
    Strict = 0,
    Pretty = 1
}
declare enum QuestionAmountRange {
    Min = 1,
    Max = 50
}
declare enum QuestionDifficulties {
    easy = "easy",
    medium = "medium",
    hard = "hard"
}
...
declare enum QuestionEncodings {
    base64 = "base64",
    none = "none",
    url3986 = "url3986",
    urlLegacy = "urlLegacy"
}
declare enum QuestionVersions {
    Raw = 0,
    Final = 1
}
